    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/d/1oOiFkLY5w8AWvSj-sFYZmEnUAeGUaPTN/p/1PTJA3AGGHmSs_ztSmHvcgIZP7MGzWSLF/edit" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com/feed/?trk=guest_homepage-basic_google-one-tap-submit" target="_blank">LinkedIn</a></li>
                    <li class="list-group-item"><a href="https://www.blog.com" target="_blank">Blog</a></li>
                    <li class="list-group-item"><a href="https://github.com/manseeadhiya/WEB_DEVELOPMENT_USING_PHP" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
                <div id="header">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="header.jpeg" alt="Logo" width="100" class="float-right">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/manseeadhiya/WEB_DEVELOPMENT_USING_PHP/tree/main/Task_1">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/manseeadhiya/WEB_DEVELOPMENT_USING_PHP/tree/main/Task-2">Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="https://github.com/manseeadhiya/WEB_DEVELOPMENT_USING_PHP/tree/main/Task-3">Task 3</a></button>
...
<button class="spring-green-button gradient-button">Database  Module</button>
    ...
    <div id="footer">
        <h3>Footer Title</h3>
        <img src="footer.jpg" alt="Footer Logo" width="100">
    </div>
